...
AJUDA, HUMANO, GERIR, CARRINHO/CART/WARENKORB), recuperação de sessão
abandonada, indicador de
...
TEXTOS = {
    ...
    "rodape_padrao": {"pt": "VOLTAR · CANCELAR · MENU · CARRINHO",
                       "de": "VOLTAR · CANCELAR · MENU · WARENKORB",
                       "en": "VOLTAR · CANCELAR · MENU · CART"},
    ...
    "ajuda_carrinho": {"pt": "• CARRINHO / CART / WARENKORB — ver o carrinho",
                        "de": "• CARRINHO / CART / WARENKORB — Warenkorb anzeigen",
                        "en": "• CARRINHO / CART / WARENKORB — view the cart"},
    ...
    # --- Carrinho e discriminação de preços -------------------------------
    "cart_lista_titulo": {"pt": "🛒 Carrinho · {total}", "de": "🛒 Warenkorb {total}",
                           "en": "🛒 Cart · {total}"},
    "cart_botao": {"pt": "🛒 Carrinho", "de": "🛒 Warenkorb", "en": "🛒 Cart"},
    "cart_titulo": {"pt": "🛒 *Carrinho*", "de": "🛒 *Warenkorb*", "en": "🛒 *Cart*"},
    "cart_vazio": {"pt": "O carrinho está vazio.", "de": "Der Warenkorb ist leer.",
                    "en": "The cart is empty."},
    "cart_subtotal": {"pt": "Subtotal", "de": "Zwischensumme", "en": "Subtotal"},
    "cart_descontos": {"pt": "Descontos", "de": "Rabatte", "en": "Discounts"},
    "cart_total": {"pt": "Total", "de": "Gesamt", "en": "Total"},
    "cart_total_estimado": {"pt": "Total estimado", "de": "Geschätzter Gesamtbetrag",
                             "en": "Estimated total"},
    "cart_continuar": {"pt": "▶️ Continuar", "de": "▶️ Fortfahren", "en": "▶️ Continue"},
    "cart_alterar": {"pt": "✏️ Alterar item", "de": "✏️ Artikel ändern", "en": "✏️ Change item"},
    "cart_esvaziar": {"pt": "🗑️ Esvaziar", "de": "🗑️ Leeren", "en": "🗑️ Empty cart"},
    "cart_alterar_corpo": {"pt": "Escolha o item que deseja alterar ou retirar:",
                            "de": "Wählen Sie den Artikel, den Sie ändern oder entfernen möchten:",
                            "en": "Choose the item you want to change or remove:"},
    "cart_alterar_seccao": {"pt": "Itens do carrinho", "de": "Warenkorbartikel", "en": "Cart items"},
    "cart_substituir_desc": {"pt": "Substituir esta escolha", "de": "Diese Auswahl ersetzen",
                              "en": "Replace this choice"},
    "cart_remover_desc": {"pt": "Retirar este item opcional", "de": "Diesen optionalen Artikel entfernen",
                           "en": "Remove this optional item"},
    "cart_removido": {"pt": "✅ Item retirado do carrinho.", "de": "✅ Artikel aus dem Warenkorb entfernt.",
                       "en": "✅ Item removed from the cart."},
    "cart_esvaziado": {"pt": "🗑️ Carrinho esvaziado.", "de": "🗑️ Warenkorb geleert.",
                        "en": "🗑️ Cart emptied."},
    "cart_grupo_ajuste": {"pt": "Ajuste", "de": "Anpassung", "en": "Adjustment"},
    "cart_cor_personalizada": {"pt": "Cor/acabamento: {valor}", "de": "Farbe/Finish: {valor}",
                               "en": "Colour/finish: {valor}"},
    "cart_precos_wrap": {"pt": "🚗 Wrap total: {total}\n🔧 Wrap parcial: {parcial}",
                          "de": "🚗 Vollfolierung: {total}\n🔧 Teilfolierung: {parcial}",
                          "en": "🚗 Full wrap: {total}\n🔧 Partial wrap: {parcial}"},
    "cart_discriminacao": {"pt": "*Discriminação do preço*", "de": "*Preisaufschlüsselung*",
                            "en": "*Price breakdown*"},
    "cart_total_wrap_nota": {"pt": "O valor é estimado e pode ser ajustado após a análise do veículo.",
                              "de": "Der Betrag ist geschätzt und kann nach der Fahrzeugprüfung angepasst werden.",
                              "en": "The amount is estimated and may be adjusted after the vehicle review."},
...
# Todos os preços vivem nesta tabela central como INTEIROS em cêntimos/centimes.
# A tabela de Wrap é de demonstração e está intencionalmente separada para ser
# alterada sem tocar na lógica do bot. Preços e fatores nunca mudam com o idioma.
...
# PREÇOS DE DEMONSTRAÇÃO — Wrap & Proteção. O valor final continua sujeito à
# análise do veículo. Acabamentos ficam preparados para o futuro fluxo guiado.
PRECOS_WRAP_DEMO_CENTIMOS = {
    "wrap_total": 250000,
    "wrap_parcial": 65000,
    "wrap_cor_standard": 0,
    "wrap_cor_personalizada": 15000,
    "wrap_acabamento_brilho": 0,
    "wrap_acabamento_mate": 15000,
    "wrap_acabamento_satinado": 20000,
    "wrap_acabamento_metalizado": 25000,
}

TABELA_PRECOS_CENTIMOS = {
    **PRECOS_SERVICOS_CENTIMOS,
    **PRECOS_WRAP_DEMO_CENTIMOS,
}

LIMPEZA_TIPOS = [
    {"id": "lp_int", "preco_centimos": TABELA_PRECOS_CENTIMOS["lp_int"],
    ...
    {"id": "lp_ext", "preco_centimos": TABELA_PRECOS_CENTIMOS["lp_ext"],
    ...
    {"id": "lp_full", "preco_centimos": TABELA_PRECOS_CENTIMOS["lp_full"],
...
EXTRAS_LIMPEZA = [
    ...
    {"id": "ex_pelos", "preco_centimos": TABELA_PRECOS_CENTIMOS["ex_pelos"],
    ...
    {"id": "ex_odores", "preco_centimos": TABELA_PRECOS_CENTIMOS["ex_odores"],
    ...
    {"id": "ex_bancos", "preco_centimos": TABELA_PRECOS_CENTIMOS["ex_bancos"],
...
ESTETICA_SERVICOS = [
    {"id": "es_polimento", "preco_centimos": TABELA_PRECOS_CENTIMOS["es_polimento"],
    ...
    {"id": "es_ceramica", "preco_centimos": TABELA_PRECOS_CENTIMOS["es_ceramica"],
    ...
    {"id": "es_farois", "preco_centimos": TABELA_PRECOS_CENTIMOS["es_farois"],
...
# ---------------------------------------------------------------------------
# Sistema central de carrinho
# ---------------------------------------------------------------------------
GRUPO_SERVICO_BASE = "serviço base"
GRUPO_VEICULO = "tipo/tamanho do veículo"
GRUPO_WRAP = "wrap total/parcial"
GRUPO_COR = "cor"
GRUPO_ACABAMENTO = "acabamento"
GRUPO_EXTRAS = "extras"
GRUPO_DESCONTO = "desconto"

GRUPOS_CARRINHO = {
    GRUPO_SERVICO_BASE, GRUPO_VEICULO, GRUPO_WRAP, GRUPO_COR,
    GRUPO_ACABAMENTO, GRUPO_EXTRAS, GRUPO_DESCONTO,
}

SLUG_GRUPO_CARRINHO = {
    GRUPO_SERVICO_BASE: "servico",
    GRUPO_VEICULO: "veiculo",
    GRUPO_WRAP: "wrap",
    GRUPO_COR: "cor",
    GRUPO_ACABAMENTO: "acabamento",
    GRUPO_EXTRAS: "extras",
...
GRUPO_POR_SLUG = {slug: grupo for grupo, slug in SLUG_GRUPO_CARRINHO.items()}

NOMES_WRAP_CARRINHO = {
    "wrap_servico": {"pt": "Wrap & Proteção", "de": "Folierung & Schutz", "en": "Wrap & Protection"},
    "wrap_total": {"pt": "Wrap total", "de": "Vollfolierung", "en": "Full wrap"},
    "wrap_parcial": {"pt": "Wrap parcial", "de": "Teilfolierung", "en": "Partial wrap"},
    "wrap_acabamento_brilho": {"pt": "Acabamento brilhante", "de": "Glanzfinish", "en": "Gloss finish"},
    "wrap_acabamento_mate": {"pt": "Acabamento mate", "de": "Mattfinish", "en": "Matte finish"},
    "wrap_acabamento_satinado": {"pt": "Acabamento acetinado", "de": "Satinfinish", "en": "Satin finish"},
    "wrap_acabamento_metalizado": {"pt": "Acabamento metalizado", "de": "Metallic-Finish", "en": "Metallic finish"},
}


def garantir_carrinho(sessao):
    """Devolve as linhas do carrinho guardado na sessão, corrigindo apenas
    formatos antigos/inválidos. O total nunca é guardado nem incrementado."""
    if not isinstance(sessao.get("carrinho"), list):
        sessao["carrinho"] = []
    return sessao["carrinho"]


def criar_linha_carrinho(id_interno, grupo, nome_canonico, preco_centimos,
                         quantidade=1, opcional=False, nome_i18n=None):
    if grupo not in GRUPOS_CARRINHO:
        raise ValueError(f"Grupo de carrinho inválido: {grupo}")
    return {
        "id": str(id_interno),
        "grupo": grupo,
        "nome_canonico": str(nome_canonico),
        "preco_centimos": int(preco_centimos),
        "quantidade": max(1, int(quantidade)),
        # O idioma escolhido nunca altera dados comerciais. Este dicionário
        # existe somente para apresentar o mesmo item em PT/DE/EN.
        "nome_i18n": nome_i18n or {"pt": str(nome_canonico)},
        "opcional": bool(opcional),
    }


def substituir_item_carrinho(sessao, linha):
    """Um grupo representa uma escolha: uma nova seleção substitui a antiga."""
    linhas = garantir_carrinho(sessao)
    sessao["carrinho"] = [l for l in linhas if l.get("grupo") != linha["grupo"]]
    sessao["carrinho"].append(linha)


def remover_grupo_carrinho(sessao, grupo):
    linhas = garantir_carrinho(sessao)
    sessao["carrinho"] = [l for l in linhas if l.get("grupo") != grupo]


def esvaziar_carrinho(sessao):
    sessao["carrinho"] = []


def totais_carrinho(sessao):
    """Recalcula tudo a partir das linhas atuais; nunca usa um total anterior."""
    subtotal = 0
    descontos = 0
    for linha in garantir_carrinho(sessao):
        valor = int(linha.get("preco_centimos", 0)) * max(1, int(linha.get("quantidade", 1)))
        if linha.get("grupo") == GRUPO_DESCONTO or valor < 0:
            descontos += valor
        else:
            subtotal += valor
    return {"subtotal_centimos": subtotal, "descontos_centimos": descontos,
            "total_centimos": subtotal + descontos}


def carrinho_e_estimado(sessao):
    return sessao.get("fluxo") == "wrap" or sessao.get("categoria") == "cat_wrap" \
        or any(l.get("grupo") == GRUPO_WRAP for l in garantir_carrinho(sessao))


def nome_linha_carrinho(linha, idioma):
    return tx(linha.get("nome_i18n"), idioma) or linha.get("nome_canonico", "-")


def texto_linha_preco(valor_centimos):
    sinal = "-" if valor_centimos < 0 else "+"
    return f"{sinal} {preco_centimos_formatado(abs(valor_centimos))}"


def formatar_discriminacao_carrinho(sessao, idioma="pt", incluir_titulo=True):
    linhas_cart = garantir_carrinho(sessao)
    if not linhas_cart:
        return t("cart_vazio", idioma)

    linhas = [t("cart_discriminacao", idioma)] if incluir_titulo else []
    for linha in linhas_cart:
        quantidade = max(1, int(linha.get("quantidade", 1)))
        valor = int(linha.get("preco_centimos", 0)) * quantidade
        sufixo_qtd = f" ×{quantidade}" if quantidade > 1 else ""
        linhas.append(f"• {nome_linha_carrinho(linha, idioma)}{sufixo_qtd} — {texto_linha_preco(valor)}")

    totais = totais_carrinho(sessao)
    linhas.append(f"{t('cart_subtotal', idioma)}: {preco_centimos_formatado(totais['subtotal_centimos'])}")
    if totais["descontos_centimos"]:
        linhas.append(f"{t('cart_descontos', idioma)}: - {preco_centimos_formatado(abs(totais['descontos_centimos']))}")
    chave_total = "cart_total_estimado" if carrinho_e_estimado(sessao) else "cart_total"
    linhas.append(f"*{t(chave_total, idioma)}: {preco_centimos_formatado(totais['total_centimos'])}*")
    if carrinho_e_estimado(sessao):
        linhas.append(t("cart_total_wrap_nota", idioma))
    return "\n".join(linhas)


def etiqueta_carrinho(sessao, idioma):
    total = preco_centimos_formatado(totais_carrinho(sessao)["total_centimos"])
    return t("cart_lista_titulo", idioma, total=total)


def limpar_grupos_comerciais(sessao):
    for grupo in (GRUPO_SERVICO_BASE, GRUPO_VEICULO, GRUPO_WRAP,
                  GRUPO_COR, GRUPO_ACABAMENTO, GRUPO_EXTRAS):
        remover_grupo_carrinho(sessao, grupo)


def _nomes_ajuste(opcao):
    return {idioma: f"{t('cart_grupo_ajuste', idioma)} · {tx(opcao['titulo'], idioma)}"
            for idioma in IDIOMAS_VALIDOS}


def _ajuste_percentual_centimos(preco_base, percentagem):
    return (int(preco_base) * (int(percentagem) - 100)) // 100


def sincronizar_carrinho(sessao):
    """Reconstrói os grupos comerciais já escolhidos a partir do estado atual.
    Assim, retomar sessão e alterações antigas produzem sempre o mesmo total."""
    ...
    if categoria == "cat_limpeza":
        servico = encontrar_opcao(LIMPEZA_TIPOS, sessao.get("tipo_id"))
        if servico:
            base = int(servico["preco_centimos"])
            substituir_item_carrinho(sessao, criar_linha_carrinho(
                servico["id"], GRUPO_SERVICO_BASE, tx(servico["titulo"], "pt"), base,
                nome_i18n=servico["titulo"]))
            tamanho = encontrar_opcao(TAMANHOS_VEICULO, sessao.get("tamanho_id"))
            if tamanho:
                ajuste = _ajuste_percentual_centimos(base, tamanho["percentagem"])
                substituir_item_carrinho(sessao, criar_linha_carrinho(
                    f"ajuste_{tamanho['id']}", GRUPO_VEICULO,
                    f"Ajuste · {tx(tamanho['titulo'], 'pt')}", ajuste,
                    nome_i18n=_nomes_ajuste(tamanho)))
            extra = encontrar_opcao(EXTRAS_LIMPEZA, sessao.get("extra_id"))
            if extra and extra["preco_centimos"]:
                substituir_item_carrinho(sessao, criar_linha_carrinho(
                    extra["id"], GRUPO_EXTRAS, tx(extra["titulo"], "pt"),
                    extra["preco_centimos"], opcional=True, nome_i18n=extra["titulo"]))

    elif categoria == "cat_estetica":
        servico = encontrar_opcao(ESTETICA_SERVICOS, sessao.get("tipo_id"))
        if servico:
            base = int(servico["preco_centimos"])
            substituir_item_carrinho(sessao, criar_linha_carrinho(
                servico["id"], GRUPO_SERVICO_BASE, tx(servico["titulo"], "pt"), base,
                nome_i18n=servico["titulo"]))
            estado = encontrar_opcao(ESTADO_VEICULO, sessao.get("estado_id"))
            if estado:
                ajuste = _ajuste_percentual_centimos(base, estado["percentagem"])
                substituir_item_carrinho(sessao, criar_linha_carrinho(
                    f"ajuste_{estado['id']}", GRUPO_VEICULO,
                    f"Ajuste · {tx(estado['titulo'], 'pt')}", ajuste,
                    nome_i18n=_nomes_ajuste(estado)))
            extra = encontrar_opcao(EXTRAS_ESTETICA, sessao.get("extra_id"))
            if extra and extra["preco_centimos"]:
                substituir_item_carrinho(sessao, criar_linha_carrinho(
                    extra["id"], GRUPO_EXTRAS, tx(extra["titulo"], "pt"),
                    extra["preco_centimos"], opcional=True, nome_i18n=extra["titulo"]))

    elif categoria == "cat_wrap" or sessao.get("fluxo") == "wrap":
        substituir_item_carrinho(sessao, criar_linha_carrinho(
            "wrap_servico", GRUPO_SERVICO_BASE, "Wrap & Proteção", 0,
            nome_i18n=NOMES_WRAP_CARRINHO["wrap_servico"]))
        tipo_wrap = sessao.get("wrap_tipo")
        if tipo_wrap in ("wrap_total", "wrap_parcial"):
            substituir_item_carrinho(sessao, criar_linha_carrinho(
                tipo_wrap, GRUPO_WRAP, NOMES_WRAP_CARRINHO[tipo_wrap]["pt"],
                TABELA_PRECOS_CENTIMOS[tipo_wrap], nome_i18n=NOMES_WRAP_CARRINHO[tipo_wrap]))
        if sessao.get("wrap_cor"):
            valor = sessao["wrap_cor"]
            nomes = {idioma: t("cart_cor_personalizada", idioma, valor=valor)
                     for idioma in IDIOMAS_VALIDOS}
            substituir_item_carrinho(sessao, criar_linha_carrinho(
                "wrap_cor_standard", GRUPO_COR, f"Cor/acabamento: {valor}",
                TABELA_PRECOS_CENTIMOS["wrap_cor_standard"], nome_i18n=nomes))


def opcoes_ajuste_com_preco(sessao, opcoes):
    base = next((l for l in garantir_carrinho(sessao)
                 if l.get("grupo") == GRUPO_SERVICO_BASE), None)
    preco_base = int(base.get("preco_centimos", 0)) if base else 0
    resultado = []
    for opcao in opcoes:
        copia = dict(opcao)
        copia["preco_centimos"] = _ajuste_percentual_centimos(
            preco_base, copia.get("percentagem", 100))
...
def garantir_coluna(conn, tabela, coluna, definicao):
    """Migração aditiva e segura para bases já existentes."""
    colunas = {linha[1] for linha in conn.execute(f"PRAGMA table_info({tabela})").fetchall()}
...
def obter_bd():
    ...
    garantir_coluna(conn, "agendamentos", "total_centimos", "INTEGER")
    garantir_coluna(conn, "agendamentos", "carrinho_json", "TEXT")
    garantir_coluna(conn, "pedidos_orcamento", "total_centimos", "INTEGER")
    garantir_coluna(conn, "pedidos_orcamento", "carrinho_json", "TEXT")
    return conn
...
def guardar_sessao(telefone, sessao):
    with obter_bd() as conn:
        conn.execute(
            ...
            (telefone, json.dumps(sessao, ensure_ascii=False)),
        )
...
def guardar_agendamento(telefone, sessao):
    sincronizar_carrinho(sessao)
    totais = totais_carrinho(sessao)
    sessao["preco"] = totais["total_centimos"] / 100
    with obter_bd() as conn:
        cur = conn.execute(
            "INSERT INTO agendamentos "
            "(telefone, nome, categoria, servico, extra, data, hora, preco, total_centimos, "
            "carrinho_json, duracao, estado, criado_em) "
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'confirmado', ?)",
            (
                telefone, sessao.get("nome"), sessao.get("categoria"),
                sessao.get("servico"), sessao.get("extra"),
                sessao.get("data"), sessao.get("hora"),
                sessao.get("preco"), totais["total_centimos"],
                json.dumps(garantir_carrinho(sessao), ensure_ascii=False), sessao.get("duracao"),
...
def listar_agendamentos():
    with obter_bd() as conn:
        linhas = conn.execute(
            "SELECT id, telefone, nome, categoria, servico, extra, data, hora, preco, total_centimos, "
            "carrinho_json, duracao, estado, criado_em "
            "FROM agendamentos ORDER BY id DESC"
        ).fetchall()
    campos = ["id", "telefone", "nome", "categoria", "servico", "extra", "data", "hora",
              "preco", "total_centimos", "carrinho_json", "duracao", "estado", "criado_em"]
    resultado = []
    for linha in linhas:
        item = dict(zip(campos, linha))
        try:
            item["carrinho"] = json.loads(item.pop("carrinho_json") or "[]")
...
def criar_pedido_orcamento(telefone, sessao):
    ...
    valores = (
        ...
        sessao.get("wrap_cor"), totais["total_centimos"],
        json.dumps(garantir_carrinho(sessao), ensure_ascii=False),
    )
    with obter_bd() as conn:
        if sessao.get("pedido_id"):
            conn.execute(
                "UPDATE pedidos_orcamento SET telefone=?, nome=?, veiculo=?, ano_veiculo=?, "
                "tipo_wrap=?, cor_acabamento=?, total_centimos=?, carrinho_json=? WHERE id=?",
                valores + (sessao["pedido_id"],),
            )
            return sessao["pedido_id"]
        cur = conn.execute(
            "INSERT INTO pedidos_orcamento "
            "(telefone, nome, veiculo, ano_veiculo, tipo_wrap, cor_acabamento, total_centimos, "
            "carrinho_json, estado, criado_em) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'novo', ?)",
...
def obter_pedido_orcamento(pedido_id):
    with obter_bd() as conn:
        linha = conn.execute(
            ...
            "agendamento_id, total_centimos, carrinho_json, criado_em "
            "FROM pedidos_orcamento WHERE id = ?", (pedido_id,)
        ).fetchone()
    if not linha:
        return None
    campos = ["id", "telefone", "nome", "veiculo", "ano_veiculo", "tipo_wrap", "cor_acabamento",
              "estado", "agendamento_id", "total_centimos", "carrinho_json", "criado_em"]
    resultado = dict(zip(campos, linha))
    try:
        resultado["carrinho"] = json.loads(resultado.pop("carrinho_json") or "[]")
    except (TypeError, json.JSONDecodeError):
        resultado["carrinho"] = []
    return resultado
...
def listar_pedidos_orcamento():
    with obter_bd() as conn:
        linhas = conn.execute(
            ...
            "p.estado, p.agendamento_id, p.total_centimos, p.carrinho_json, p.criado_em, "
            "COUNT(f.id) AS num_fotos "
            "FROM pedidos_orcamento p LEFT JOIN fotografias f ON f.pedido_id = p.id "
            "GROUP BY p.id ORDER BY p.id DESC"
        ).fetchall()
    campos = ["id", "telefone", "nome", "veiculo", "ano_veiculo", "tipo_wrap", "cor_acabamento",
              "estado", "agendamento_id", "total_centimos", "carrinho_json", "criado_em", "num_fotos"]
    resultado = []
    for linha in linhas:
        item = dict(zip(campos, linha))
        try:
...
def enviar_lista(destinatario, corpo, titulo_seccao, opcoes, idioma, botao="👉 Escolher",
                 com_voltar=False, rodape=None, incluir_carrinho=True):
    ...
    for i, opc in enumerate(opcoes):
        if isinstance(opc, dict):
            ...
            if "preco_centimos" in opc:
                preco_opcao = preco_centimos_formatado(opc["preco_centimos"])
                desc = f"{preco_opcao} · {desc}" if desc else preco_opcao
            if desc:
    ...
    sessao = carregar_sessao(destinatario)
    if incluir_carrinho and sessao.get("idioma") in IDIOMAS_VALIDOS:
        rows.append({"id": "cart_ver", "title": etiqueta_carrinho(sessao, idioma)[:24],
                     "description": t("cart_alterar_desc", idioma)[:72]})
...
def enviar_botoes(destinatario, corpo, botoes, idioma, rodape=None, incluir_carrinho=True):
    botoes_finais = list(botoes)
    sessao = carregar_sessao(destinatario)
    tem_idioma = sessao.get("idioma") in IDIOMAS_VALIDOS
    if incluir_carrinho and tem_idioma and len(botoes_finais) < 3 \
            and not any(b.get("id") == "cart_ver" for b in botoes_finais):
        botoes_finais.append({"id": "cart_ver", "titulo": t("cart_botao", idioma)})
    elif incluir_carrinho and tem_idioma and not rodape:
        rodape = t("rodape_padrao", idioma)
    interactive = {
        "type": "button",
        "body": {"text": corpo},
        "action": {"buttons": [
            {"type": "reply", "reply": {"id": b["id"], "title": tx(b["titulo"], idioma)[:20]}}
            for b in botoes_finais[:3]
        ]},
    }
    if rodape:
        interactive["footer"] = {"text": rodape}
...
def preco_centimos_formatado(valor_centimos):
    valor = int(valor_centimos or 0)
    return f"CHF {valor / 100:.2f}"


def preco_formatado(valor, idioma="pt"):
    """Compatibilidade com a coluna histórica REAL (francos) do dashboard."""
    if valor is None:
        return t("preco_a_combinar", idioma)
    return preco_centimos_formatado(round(float(valor) * 100))
...
def mostrar_carrinho(de, idioma, sessao):
    corpo = f"{t('cart_titulo', idioma)}\n\n{formatar_discriminacao_carrinho(sessao, idioma)}"
    enviar_botoes(de, corpo, [
        {"id": "cart_continuar", "titulo": t("cart_continuar", idioma)},
        {"id": "cart_alterar", "titulo": t("cart_alterar", idioma)},
        {"id": "cart_esvaziar", "titulo": t("cart_esvaziar", idioma)},
    ], idioma, incluir_carrinho=False)
...
def mostrar_alterar_carrinho(de, idioma, sessao):
    ...
    opcoes = []
    for linha in linhas:
        slug = SLUG_GRUPO_CARRINHO.get(linha.get("grupo"))
        if not slug:
            continue
        opcional = bool(linha.get("opcional")) or linha.get("grupo") == GRUPO_DESCONTO
        opcoes.append({
            "id": f"cart_item_{slug}",
            "titulo": nome_linha_carrinho(linha, idioma),
            "descricao": t("cart_remover_desc" if opcional else "cart_substituir_desc", idioma),
        })
    enviar_lista(de, t("cart_alterar_corpo", idioma), t("cart_alterar_seccao", idioma),
                 opcoes, idioma, botao=t("cart_alterar", idioma),
                 rodape=t("rodape_padrao", idioma))


def _limpar_campos(sessao, *campos):
    for campo in campos:
        sessao.pop(campo, None)


def processar_acao_carrinho(de, idioma, sessao, acao):
    """Processa comandos e ações interativas do carrinho. Devolve True quando
    a ação foi reconhecida, para o webhook poder terminar imediatamente."""
    if acao == "cart_ver":
        mostrar_carrinho(de, idioma, sessao)
        return True
    if acao == "cart_continuar":
        reenviar_passo_atual(de, idioma, sessao)
        return True
    if acao == "cart_alterar":
        mostrar_alterar_carrinho(de, idioma, sessao)
        return True
    if acao == "cart_esvaziar":
        nova = sessao_preservando_perfil(sessao)
        guardar_sessao(de, nova)
        enviar_texto(de, t("cart_esvaziado", idioma))
        enviar_menu_principal(de, idioma, saudacao=False)
        return True
    if not acao.startswith("cart_item_"):
        return False

    slug = acao.removeprefix("cart_item_")
    grupo = GRUPO_POR_SLUG.get(slug)
    linha = next((l for l in garantir_carrinho(sessao) if l.get("grupo") == grupo), None)
    if not grupo or not linha:
        mostrar_carrinho(de, idioma, sessao)
        return True

    if linha.get("opcional") or grupo == GRUPO_DESCONTO:
        remover_grupo_carrinho(sessao, grupo)
        if grupo == GRUPO_EXTRAS:
            sessao["extra_id"] = "ex_nenhum" if sessao.get("categoria") == "cat_limpeza" else "exe_nenhum"
            sessao["extra"] = None
        guardar_sessao(de, sessao)
        enviar_texto(de, t("cart_removido", idioma))
        mostrar_carrinho(de, idioma, sessao)
        return True

    categoria = sessao.get("categoria")
    if grupo == GRUPO_SERVICO_BASE:
        _limpar_campos(sessao, "tipo_id", "tamanho_id", "estado_id", "extra_id", "data", "hora",
                       "servico", "extra", "preco", "duracao", "wrap_tipo", "wrap_cor",
                       "aguardando_fotos")
        limpar_grupos_comerciais(sessao)
        guardar_sessao(de, sessao)
        if categoria == "cat_limpeza":
    ...
    if grupo == GRUPO_VEICULO:
        _limpar_campos(sessao, "tamanho_id", "estado_id", "extra_id", "data", "hora",
                       "servico", "extra", "preco", "duracao")
        sincronizar_carrinho(sessao)
        guardar_sessao(de, sessao)
        (passo_limpeza_tamanho if categoria == "cat_limpeza" else passo_estetica_estado)(de, idioma)
        return True

    if grupo == GRUPO_WRAP:
        _limpar_campos(sessao, "wrap_tipo", "wrap_cor", "aguardando_fotos")
        sincronizar_carrinho(sessao)
        guardar_sessao(de, sessao)
        passo_wrap_tipo(de, idioma)
        return True

    if grupo in (GRUPO_COR, GRUPO_ACABAMENTO):
        _limpar_campos(sessao, "wrap_cor", "aguardando_fotos")
        sincronizar_carrinho(sessao)
        guardar_sessao(de, sessao)
...
def passo_limpeza_tamanho(de, idioma):
    ...
    opcoes = opcoes_ajuste_com_preco(sessao, TAMANHOS_VEICULO)
...
def passo_estetica_estado(de, idioma):
    sessao = carregar_sessao(de)
    opcoes = opcoes_ajuste_com_preco(sessao, ESTADO_VEICULO)
...
def calcular_preco_duracao(sessao):
    ...
    if sessao.get("categoria") == "cat_limpeza":
        ...
        extra = encontrar_opcao(EXTRAS_LIMPEZA, sessao.get("extra_id")) or {"titulo": None}
        sincronizar_carrinho(sessao)
        preco = totais_carrinho(sessao)["total_centimos"] / 100
        return (preco, tx(tipo.get("duracao", "-"), "pt"),
    ...
    if sessao.get("categoria") == "cat_estetica":
        ...
        extra = encontrar_opcao(EXTRAS_ESTETICA, sessao.get("extra_id")) or {"titulo": None}
        sincronizar_carrinho(sessao)
        preco = totais_carrinho(sessao)["total_centimos"] / 100
        return (preco, tx(serv.get("duracao", "-"), "pt"),
...
def passo_resumo(de, idioma, sessao):
    ...
    linhas.append("")
    linhas.append(formatar_discriminacao_carrinho(sessao, idioma))
...
def mensagem_notificacao_provider(de, sessao, id_agendamento):
    ...
    linhas.append("")
    linhas.append(formatar_discriminacao_carrinho(sessao, "pt"))
    linhas.append("")
...
def passo_wrap_tipo(de, idioma):
    corpo = t("wrap_passo2_corpo", idioma) + "\n\n" + t(
        "cart_precos_wrap", idioma,
        total=preco_centimos_formatado(TABELA_PRECOS_CENTIMOS["wrap_total"]),
        parcial=preco_centimos_formatado(TABELA_PRECOS_CENTIMOS["wrap_parcial"]),
    )
    enviar_botoes(de, corpo, [
...
def mensagem_ajuda(idioma):
    linhas = [t("ajuda_header", idioma), "", t("ajuda_menu", idioma), t("ajuda_voltar", idioma),
              ...
              t("ajuda_humano", idioma), t("ajuda_carrinho", idioma), t("ajuda_idioma", idioma)]
    return "\n".join(linhas)
...
def versao():
    return jsonify(versao="v5-carrinho", fluxos=["limpeza", "estetica", "wrap"], idiomas=list(IDIOMAS_VALIDOS)), 200
...
def processar_comando_texto(de, idioma, sessao, comando):
    ...
    if comando == "gerir":
        ...
        return True
    if comando in ("carrinho", "cart", "warenkorb"):
        mostrar_carrinho(de, idioma, sessao)
        return True
    if comando == "cancelar":
        reiniciar_sessao(de)
...
def voltar_um_passo(de, idioma, sessao):
    ...
    if fluxo == "wrap":
        if sessao.get("aguardando_fotos"):
            ...
            sessao.pop("wrap_cor", None); sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_wrap_cor(de, idioma)
        elif "wrap_tipo" in sessao:
            sessao.pop("wrap_tipo", None); sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_wrap_tipo(de, idioma)
    ...
    if categoria in ("cat_limpeza", "cat_estetica"):
        if "hora" in sessao:
            ...
            sessao.pop("extra_id", None); sincronizar_carrinho(sessao); guardar_sessao(de, sessao)
            ...
            sessao.pop("tamanho_id", None); sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_limpeza_tamanho(de, idioma)
        elif categoria == "cat_estetica" and "estado_id" in sessao:
            sessao.pop("estado_id", None); sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_estetica_estado(de, idioma)
...
def receber_mensagem():
    ...
    try:
        ...
        if tipo == "interactive" and msg["interactive"]["type"] == "button_reply":
            ...
            if processar_acao_carrinho(de, idioma, sessao, id_botao):
                return jsonify(status="ok"), 200
            ...
            if id_botao in NOME_CATEGORIA:  # categoria dentro de "Marcar"
                _limpar_campos(sessao, "tipo_id", "tamanho_id", "estado_id", "extra_id", "data", "hora",
                               "servico", "extra", "preco", "duracao", "wrap_veiculo", "wrap_tipo",
                               "wrap_cor", "aguardando_fotos", "pedido_id")
                limpar_grupos_comerciais(sessao)
        ...
        if tipo == "interactive" and msg["interactive"]["type"] == "list_reply":
            ...
            if processar_acao_carrinho(de, idioma, sessao, id_escolhido):
                return jsonify(status="ok"), 200
            ...
            if categoria == "cat_limpeza":
                if "tipo_id" not in sessao:
                    sessao["tipo_id"] = id_escolhido; sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_limpeza_tamanho(de, idioma)
                elif "tamanho_id" not in sessao:
                    sessao["tamanho_id"] = id_escolhido; sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_limpeza_extra(de, idioma)
                elif "extra_id" not in sessao:
                    sessao["extra_id"] = id_escolhido; sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_data(de, idioma)
            ...
            if categoria == "cat_estetica":
                if "tipo_id" not in sessao:
                    sessao["tipo_id"] = id_escolhido; sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_estetica_estado(de, idioma)
                elif "estado_id" not in sessao:
                    sessao["estado_id"] = id_escolhido; sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_estetica_extra(de, idioma)
                elif "extra_id" not in sessao:
                    sessao["extra_id"] = id_escolhido; sincronizar_carrinho(sessao); guardar_sessao(de, sessao); passo_data(de, idioma)
                elif "data" not in sessao:
                    sessao["data"] = msg["interactive"]["list_reply"]["title"]; guardar_sessao(de, sessao); passo_hora(de, idioma)
